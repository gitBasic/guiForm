...
class Register:
    def __init__(self,root):
        ...
        self.left=ImageTk.PhotoImage(file="2.jpg")
        ...
        self.var_chk=IntVar()
        chk=Checkbutton(frame1,text="I Agree The Terms & Conditions",onvalue=1,variable=self.var_chk,offvalue=0,bg="white",font=("times new roman",12)).place(x=47,y=380)


        self.btn_img=ImageTk.PhotoImage(file="3.jpg")
    ...
    def register_data(self):
        if  self.txt_fname.get()=='' or self.txt_lname.get()=='' or self.txt_contact.get()=='' or self.txt_email.get()=='' or self.cmb_quest.get()=='Select' or self.txt_answer.get()=='' or self.txt_password.get()=='' or self.txt_cpassword.get()=='' :
            ...
            messagebox.showerror("Error","Please Approve Terms and Conditions",parent=self.root)

        else:
            try:
                con=pymysql.connect(host='localhost',user='root',database='employee',port=3306)
